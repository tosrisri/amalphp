...
<head>
  ...
  <title>AMAL College - NAAC - Governance, Leadership and Management</title>
...
<body class="inner-pages bg-logo scrolling-box" >
    ...
    <div class="container">
      ...
      <div class="row">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Governance, Leadership and Management</li>
        </ol>
      </div>
      <!-- /Breadcrumbs -->
    </div>
  ...
  <!-- second-level-nav -->
    <div class="container mt-5">
      <ul class="nav nav-pills" id="secNavPills">
        ...
        <li class="nav-item"><a class="nav-link active" href="naac-gov.php">Governance</a></li>
  ...
  <section>
    <div class="container">
      <div class="w-100">
        <h2 class="subheading w-100">Governance, Leadership and Management</h2>        
      </div>
      <div class="row">
          <div class="col">
