...
<head>
  ...
  <title>AMAL College - NAAC - Student Support and Prgression</title>
...
<body class="inner-pages bg-logo scrolling-box" >
    ...
    <div class="container">
      ...
      <div class="row">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Student Support and Prgression</li>
        </ol>
      </div>
      <!-- /Breadcrumbs -->
    </div>
  ...
  <!-- second-level-nav -->
    <div class="container mt-5">
      <ul class="nav nav-pills" id="secNavPills">
        ...
        <li class="nav-item"><a class="nav-link active" href="naac-ss.php">Student Support</a></li>
  ...
  <section>
    <div class="container">
      <div class="w-100">
        <h2 class="subheading w-100">Student Support and Prgression</h2>        
      </div>
      <div class="row">
          <div class="col">
