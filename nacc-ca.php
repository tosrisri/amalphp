...
<head>
  ...
  <title>AMAL College - NAAC - Curricular Aspects</title>
...
<body class="inner-pages bg-logo scrolling-box" >
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto" id="priNavBar">
          ...
          <li class="nav-item active"><a class="nav-link" href="about-naac.php">NAAC</a></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Curricular Aspects</li>
        </ol>
      </div>
      <!-- /Breadcrumbs -->
    </div>
  ...
  <!-- second-level-nav -->
    <div class="container mt-5">
      <ul class="nav nav-pills" id="secNavPills">
        ...
        <li class="nav-item"><a class="nav-link active" href="nacc-ca.php">Curricular Aspects</a></li>
        <li class="nav-item"><a class="nav-link" href="naac-teaching.php">Teaching</a></li>
        <li class="nav-item"><a class="nav-link" href="naac-res.php">Research</a></li>
  ...
  <section>
    <div class="container">
      <div class="w-100">
        <h2 class="subheading w-100">Curricular Aspects</h2>        
      </div>
      <div class="row">
          <div class="col">
          <p>Content Coming Soon...</p>
          <img src="https://via.placeholder.com/100/09f.png/fff" />

          <!-- <img src="images/alumni-vangalapudi-anitha.jpg" /> -->
