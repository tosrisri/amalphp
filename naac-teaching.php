...
<head>
  ...
  <title>AMAL College - NAAC - Teaching, Learning and Evaluation</title>
...
<body class="inner-pages bg-logo scrolling-box" >
    ...
    <div class="container">
      ...
      <div class="row">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Teaching, Learning and Evaluation</li>
        </ol>
      </div>
      <!-- /Breadcrumbs -->
    </div>
  ...
  <!-- second-level-nav -->
    <div class="container mt-5">
      <ul class="nav nav-pills" id="secNavPills">
        ...
        <li class="nav-item"><a class="nav-link active" href="naac-teaching.php">Teaching</a></li>
  ...
  <section>
    <div class="container">
      <div class="w-100">
        <h2 class="subheading w-100"> Teaching, Learning and Evaluation</h2>        
      </div>
      <div class="row">
          <div class="col">
