...
<head>
  ...
  <title>AMAL College - NAAC - Research, Innovation and Extension</title>
    ...
    <div class="container">
      ...
      <div class="row">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Research, Innovation and Extension</li>
        </ol>
      </div>
      <!-- /Breadcrumbs -->
    </div>
  ...
  <!-- second-level-nav -->
    <div class="container mt-5">
      <ul class="nav nav-pills" id="secNavPills">
        ...
        <li class="nav-item"><a class="nav-link active" href="naac-res.php">Research</a></li>
